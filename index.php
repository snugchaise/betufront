...
#     get_head(False,$logged_in,array(),$meta_content);
     ...
     echo '<a role="menuitem" class="tracking-navigation-link atc-primary-nav__top-level" href="/sell-book">'.PHP_EOL;
...
if(preg_match('/add-online-test\//', $request)){
        $handler = new DatabaseHandler;
        ...
        $handler->insert_into_table("online_tests",array("title","titleForUrl","active_online_test"),array("title" => $random_title, "titleForUrl" => $random_title,"active_online_test" => 0));
        $redirect_route = "Location: http://".$GLOBALS['project_name'].".com/online-test-edit/".$random_title."/057a39a1cf79eb4625c16c51eadd3283";
        header($redirect_route);
}
if(preg_match('/online-test-edit\//', $request)){
        ...
        $tests = $handler->conditional_select_from("online_tests",array("titleForUrl" => $title ));
        $this_test = $tests[0];
        $this_id = $tests[0]['id'];
        ...
        echo '<textarea id="title_box" onchange="set_title();" style="width: 100%;" >'.$this_test['title'].'</textarea>';
        echo '<textarea id="initial_box" onchange="set_initial();" style="width: 100%;height: 12em;" >'.$this_test['initial'].'</textarea>';
        echo '<textarea id="type_string_box" onchange="set_type_string();" style="width: 100%;height: 4em;" >'.$this_test['type_string'].'</textarea>';
        echo '<textarea id="type_box" onchange="set_type();" style="width: 100%;height: 4em;" >'.$this_test['type'].'</textarea>';
        echo '<textarea id="title_for_url_box" onchange="set_title_for_url();" style="width: 100%;height: 4em;" >'.$this_test['titleForUrl'].'</textarea>';

  echo '<label for="target_word_1">Szo 1:</label>'.PHP_EOL;
  echo '<textarea id="target_word_1" onchange="set_target_word_1();" style="width: 100%;height: 4em;" >'.$this_test['target_word_1'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_1_a">Szo A 1:</label>'.PHP_EOL;
  echo '<textarea id="target_word_1_a" onchange="set_target_word_1_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_1_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_1_b">Szo B 1:</label>'.PHP_EOL;
  echo '<textarea id="target_word_1_b" onchange="set_target_word_1_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_1_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_1_c">Szo C 1:</label>'.PHP_EOL;
  echo '<textarea id="target_word_1_c" onchange="set_target_word_1_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_1_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_2">Szo 2:</label>'.PHP_EOL;
  echo '<textarea id="target_word_2" onchange="set_target_word_2();" style="width: 100%;height: 4em;" >'.$this_test['target_word_2'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_2_a">Szo A 2:</label>'.PHP_EOL;
  echo '<textarea id="target_word_2_a" onchange="set_target_word_2_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_2_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_2_b">Szo B 2:</label>'.PHP_EOL;
  echo '<textarea id="target_word_2_b" onchange="set_target_word_2_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_2_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_2_c">Szo C 2:</label>'.PHP_EOL;
  echo '<textarea id="target_word_2_c" onchange="set_target_word_2_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_2_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_3">Szo 3:</label>'.PHP_EOL;
  echo '<textarea id="target_word_3" onchange="set_target_word_3();" style="width: 100%;height: 4em;" >'.$this_test['target_word_3'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_3_a">Szo A 3:</label>'.PHP_EOL;
  echo '<textarea id="target_word_3_a" onchange="set_target_word_3_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_3_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_3_b">Szo B 3:</label>'.PHP_EOL;
  echo '<textarea id="target_word_3_b" onchange="set_target_word_3_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_3_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_3_c">Szo C 3:</label>'.PHP_EOL;
  echo '<textarea id="target_word_3_c" onchange="set_target_word_3_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_3_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_4">Szo 4:</label>'.PHP_EOL;
  echo '<textarea id="target_word_4" onchange="set_target_word_4();" style="width: 100%;height: 4em;" >'.$this_test['target_word_4'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_4_a">Szo A 4:</label>'.PHP_EOL;
  echo '<textarea id="target_word_4_a" onchange="set_target_word_4_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_4_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_4_b">Szo B 4:</label>'.PHP_EOL;
  echo '<textarea id="target_word_4_b" onchange="set_target_word_4_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_4_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_4_c">Szo C 4:</label>'.PHP_EOL;
  echo '<textarea id="target_word_4_c" onchange="set_target_word_4_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_4_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_5">Szo 5:</label>'.PHP_EOL;
  echo '<textarea id="target_word_5" onchange="set_target_word_5();" style="width: 100%;height: 4em;" >'.$this_test['target_word_5'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_5_a">Szo A 5:</label>'.PHP_EOL;
  echo '<textarea id="target_word_5_a" onchange="set_target_word_5_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_5_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_5_b">Szo B 5:</label>'.PHP_EOL;
  echo '<textarea id="target_word_5_b" onchange="set_target_word_5_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_5_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_5_c">Szo C 5:</label>'.PHP_EOL;
  echo '<textarea id="target_word_5_c" onchange="set_target_word_5_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_5_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_6">Szo 6:</label>'.PHP_EOL;
  echo '<textarea id="target_word_6" onchange="set_target_word_6();" style="width: 100%;height: 4em;" >'.$this_test['target_word_6'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_6_a">Szo A 6:</label>'.PHP_EOL;
  echo '<textarea id="target_word_6_a" onchange="set_target_word_6_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_6_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_6_b">Szo B 6:</label>'.PHP_EOL;
  echo '<textarea id="target_word_6_b" onchange="set_target_word_6_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_6_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_6_c">Szo C 6:</label>'.PHP_EOL;
  echo '<textarea id="target_word_6_c" onchange="set_target_word_6_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_6_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_7">Szo 7:</label>'.PHP_EOL;
  echo '<textarea id="target_word_7" onchange="set_target_word_7();" style="width: 100%;height: 4em;" >'.$this_test['target_word_7'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_7_a">Szo A 7:</label>'.PHP_EOL;
  echo '<textarea id="target_word_7_a" onchange="set_target_word_7_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_7_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_7_b">Szo B 7:</label>'.PHP_EOL;
  echo '<textarea id="target_word_7_b" onchange="set_target_word_7_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_7_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_7_c">Szo C 7:</label>'.PHP_EOL;
  echo '<textarea id="target_word_7_c" onchange="set_target_word_7_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_7_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_8">Szo 8:</label>'.PHP_EOL;
  echo '<textarea id="target_word_8" onchange="set_target_word_8();" style="width: 100%;height: 4em;" >'.$this_test['target_word_8'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_8_a">Szo A 8:</label>'.PHP_EOL;
  echo '<textarea id="target_word_8_a" onchange="set_target_word_8_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_8_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_8_b">Szo B 8:</label>'.PHP_EOL;
  echo '<textarea id="target_word_8_b" onchange="set_target_word_8_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_8_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_8_c">Szo C 8:</label>'.PHP_EOL;
  echo '<textarea id="target_word_8_c" onchange="set_target_word_8_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_8_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_9">Szo 9:</label>'.PHP_EOL;
  echo '<textarea id="target_word_9" onchange="set_target_word_9();" style="width: 100%;height: 4em;" >'.$this_test['target_word_9'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_9_a">Szo A 9:</label>'.PHP_EOL;
  echo '<textarea id="target_word_9_a" onchange="set_target_word_9_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_9_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_9_b">Szo B 9:</label>'.PHP_EOL;
  echo '<textarea id="target_word_9_b" onchange="set_target_word_9_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_9_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_9_c">Szo C 9:</label>'.PHP_EOL;
  echo '<textarea id="target_word_9_c" onchange="set_target_word_9_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_9_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_10">Szo 10:</label>'.PHP_EOL;
  echo '<textarea id="target_word_10" onchange="set_target_word_10();" style="width: 100%;height: 4em;" >'.$this_test['target_word_10'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_10_a">Szo A 10:</label>'.PHP_EOL;
  echo '<textarea id="target_word_10_a" onchange="set_target_word_10_a();" style="width: 100%;height: 4em;" >'.$this_test['target_word_10_a'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_10_b">Szo B 10:</label>'.PHP_EOL;
  echo '<textarea id="target_word_10_b" onchange="set_target_word_10_b();" style="width: 100%;height: 4em;" >'.$this_test['target_word_10_b'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="target_word_10_c">Szo C 10:</label>'.PHP_EOL;
  echo '<textarea id="target_word_10_c" onchange="set_target_word_10_c();" style="width: 100%;height: 4em;" >'.$this_test['target_word_10_c'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;

  echo '<label for="solution_1">Solution 1:</label>'.PHP_EOL;
  echo '<textarea id="solution_1" onchange="set_solution_1();" style="width: 100%;height: 4em;" >'.$this_test['solution_1'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_2">Solution 2:</label>'.PHP_EOL;
  echo '<textarea id="solution_2" onchange="set_solution_2();" style="width: 100%;height: 4em;" >'.$this_test['solution_2'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_3">Solution 3:</label>'.PHP_EOL;
  echo '<textarea id="solution_3" onchange="set_solution_3();" style="width: 100%;height: 4em;" >'.$this_test['solution_3'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_4">Solution 4:</label>'.PHP_EOL;
  echo '<textarea id="solution_4" onchange="set_solution_4();" style="width: 100%;height: 4em;" >'.$this_test['solution_4'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_5">Solution 5:</label>'.PHP_EOL;
  echo '<textarea id="solution_5" onchange="set_solution_5();" style="width: 100%;height: 4em;" >'.$this_test['solution_5'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_6">Solution 6:</label>'.PHP_EOL;
  echo '<textarea id="solution_6" onchange="set_solution_6();" style="width: 100%;height: 4em;" >'.$this_test['solution_6'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_7">Solution 7:</label>'.PHP_EOL;
  echo '<textarea id="solution_7" onchange="set_solution_7();" style="width: 100%;height: 4em;" >'.$this_test['solution_7'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_8">Solution 8:</label>'.PHP_EOL;
  echo '<textarea id="solution_8" onchange="set_solution_8();" style="width: 100%;height: 4em;" >'.$this_test['solution_8'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_9">Solution 9:</label>'.PHP_EOL;
  echo '<textarea id="solution_9" onchange="set_solution_9();" style="width: 100%;height: 4em;" >'.$this_test['solution_9'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;
  echo '<label for="solution_10">Solution 10:</label>'.PHP_EOL;
  echo '<textarea id="solution_10" onchange="set_solution_10();" style="width: 100%;height: 4em;" >'.$this_test['solution_10'].'</textarea>'.PHP_EOL;
  echo '<br>'.PHP_EOL;



        $tests = array_reverse($handler->select_all_from("online_tests"));

        echo '<br>';
        echo '<span style="color: black" >Feltöltés: scp jpg qqwwaass@107.180.50.188:/home/qqwwaass/'.$GLOBALS['project_name'].'/images/'.$this_id.'/1.jpg </span>';
        echo '<br>';
        ...
        echo '<input  type="hidden" name="post_id" value="'.$this_id.'"/>'.PHP_EOL;
        echo '</form>'.PHP_EOL;
        ...
        echo '</section>'.PHP_EOL;
        echo '<script>'.PHP_EOL;
        echo 'function set_solution_1(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_1").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-1/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_2(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_2").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-2/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_3(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_3").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-3/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_4(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_4").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-4/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_5(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_5").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-5/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_6(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_6").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-6/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_7(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_7").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-7/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_8(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_8").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-8/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_9(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_9").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-9/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_solution_10(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("solution_10").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/set-solution-10/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-initial/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-type-string/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-type/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        ...
        echo 'var reference_online_test_1 = document.getElementById("reference_online_test_1").value; '.PHP_EOL;
        echo 'var reference_online_test_2 = document.getElementById("reference_online_test_2").value;'.PHP_EOL;
        echo 'var reference_online_test_3 = document.getElementById("reference_online_test_3").value;'.PHP_EOL;
        echo 'var reference_online_test_4 = document.getElementById("reference_online_test_4").value;'.PHP_EOL;
        echo 'var reference_online_test_5 = document.getElementById("reference_online_test_5").value;'.PHP_EOL;

        echo 'var reference_online_test_1_text_1 = document.getElementById("reference_online_test_1"); '.PHP_EOL;
        echo 'var reference_online_test_2_text_1 = document.getElementById("reference_online_test_2");'.PHP_EOL;
        echo 'var reference_online_test_3_text_1 = document.getElementById("reference_online_test_3");'.PHP_EOL;
        echo 'var reference_online_test_4_text_1 = document.getElementById("reference_online_test_4");'.PHP_EOL;
        echo 'var reference_online_test_5_text_1 = document.getElementById("reference_online_test_5");'.PHP_EOL;

        echo 'var reference_online_test_1_text = reference_online_test_1_text_1.options[reference_online_test_1_text_1.selectedIndex].text;'.PHP_EOL;
        echo 'var reference_online_test_2_text = reference_online_test_2_text_1.options[reference_online_test_2_text_1.selectedIndex].text;'.PHP_EOL;
        echo 'var reference_online_test_3_text = reference_online_test_3_text_1.options[reference_online_test_3_text_1.selectedIndex].text;'.PHP_EOL;
        echo 'var reference_online_test_4_text = reference_online_test_4_text_1.options[reference_online_test_4_text_1.selectedIndex].text;'.PHP_EOL;
        echo 'var reference_online_test_5_text = reference_online_test_5_text_1.options[reference_online_test_5_text_1.selectedIndex].text;'.PHP_EOL;

        echo 'document.getElementById("content2_box").value = "<div class=\'review_text_container\'>\n<div class=\'review_text\'> \n Ezek is érdekesek lehetnek: \n <ul style=\'line-height: 4em\'> \n <li><a href=\'/online_test/"+reference_online_test_1+"\'>"+reference_online_test_1_text+"</a></li> \n <li><a href=\'/online_test/"+reference_online_test_2+"\'>"+reference_online_test_2_text+"</a></li> \n <li><a href=\'/online_test/"+reference_online_test_3+"\'>"+reference_online_test_3_text+"</a></li> \n <li><a href=\'/online_test/"+reference_online_test_4+"\'>"+reference_online_test_4_text+"</a></li> \n <li><a href=\'/online_test/"+reference_online_test_5+"\'>"+reference_online_test_5_text+"</a></li> \n </ul> \n </div> \n</div>"; '.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-title/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/deactivate-online-test/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/activate-online-test/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
	...
	echo '<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>'.PHP_EOL;
        ...
        echo '    $.ajax({'.PHP_EOL;
        echo '        type : "POST",'.PHP_EOL;
        echo '        url: \'/handle_online_test_image_upload/\','.PHP_EOL;
        echo '        data : new FormData(this),'.PHP_EOL;
        echo '        contentType: false,'.PHP_EOL;
        echo '        cache: false,'.PHP_EOL;
        echo '        processData:false,'.PHP_EOL;
        ...
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-title-for-url/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo 'function set_target_word_1(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_1").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-1/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_1_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_1_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-1_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_1_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_1_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-1_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_1_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_1_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-1_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_2(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_2").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-2/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_2_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_2_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-2_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_2_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_2_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-2_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_2_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_2_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-2_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_3(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_3").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-3/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_3_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_3_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-3_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_3_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_3_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-3_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_3_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_3_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-3_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_4(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_4").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-4/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_4_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_4_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-4_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_4_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_4_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-4_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_4_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_4_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-4_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_5(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_5").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-5/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_5_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_5_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-5_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_5_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_5_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-5_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_5_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_5_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-5_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_6(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_6").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-6/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_6_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_6_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-6_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_6_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_6_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-6_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_6_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_6_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-6_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_7(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_7").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-7/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_7_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_7_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-7_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_7_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_7_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-7_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_7_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_7_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-7_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_8(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_8").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-8/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_8_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_8_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-8_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_8_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_8_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-8_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_8_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_8_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-8_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_9(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_9").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-9/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_9_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_9_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-9_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_9_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_9_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-9_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_9_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_9_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-9_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_10(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_10").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-10/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_10_a(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_10_a").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-10_a/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_10_b(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_10_b").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-10_b/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
        ...
        echo '    }); '.PHP_EOL;
        echo ' };'.PHP_EOL;
        echo 'function set_target_word_10_c(){'.PHP_EOL;
        echo 'var jsondata = { '.PHP_EOL;
        echo '        "id": '.$this_id.', '.PHP_EOL;
        echo '        "titleForUrl": document.getElementById("target_word_10_c").value '.PHP_EOL;
        echo '    };   '.PHP_EOL;
        echo ' '.PHP_EOL;
        echo '    $.ajax({ '.PHP_EOL;
        echo '        url: "/edit-online-test-set-target-word-10_c/", '.PHP_EOL;
        echo '        method: "POST",         '.PHP_EOL;
        echo '        data: JSON.stringify({ Data: jsondata }), '.PHP_EOL;
        echo '        contentType: "json", '.PHP_EOL;
        echo '        success: function(data){ '.PHP_EOL;
...
echo '<div>Természetesen van <a href="https://www.facebook.com/Spanyoltanul&#xe1;scom-110031217438374" style="color: black; text-decoration: underline!important;">Facebook oldalunk</a> is, de a legegyszerűbben online veheted fel a kapcsolatot velünk. Ha fel szeretnéd velünk venni a kapcsolatot használd a következő kapcsolattartási mezőket és küldj nekünk üzenetet.</div><br>'.PHP_EOL;
echo '<div style="float: right" >2020. július - Az üzemeltető</div><br>'.PHP_EOL;
echo '<h3>Kapcsolat</h3>'.PHP_EOL;
echo '<div id="message_from_user">'.PHP_EOL;
echo '<input type="text" style="margin-bottom: 10px" class="form-control" id="email_address" placeholder="E-mail cím">'.PHP_EOL;
echo '<input type="text" style="margin-bottom: 10px" class="form-control" id="user_name" placeholder="Név">'.PHP_EOL;
