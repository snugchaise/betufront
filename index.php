...
if(preg_match('/search-result\//', $request)){
     $keyword  = str_replace('%20', ' ', explode("/",$request)[2]);
...
#     get_head(False,$logged_in,array(),$meta_content);
     ...
     echo '<div style="background: #e9e9e9;height: 100%;width: 100%;z-index: 1000;position: fixed;">'.PHP_EOL;
...
echo '<textarea id="book_title_box" onchange="set_book_title();" style="width: 100%;height: 2em;" >'.$bfs['book_title'].'</textarea>';
...
echo '<textarea id="book_price_box" onchange="set_book_price();" style="width: 100%;height: 2em;" >'.$bfs['book_price'].'</textarea>';

echo '<h4>Oldalainak száma</h4>'.PHP_EOL;
echo '<textarea id="book_page_number_box" onchange="set_book_page_number();" style="width: 100%;height: 2em;" >'.$bfs['book_page_numbers'].'</textarea>';

echo '<h4>Kiadás éve</h4>'.PHP_EOL;
echo '<textarea id="book_publish_date_box" onchange="set_publish_date();" style="width: 100%;height: 2em;" >'.$bfs['book_publish_date'].'</textarea>';

echo '<h4>ISBN száma (ha van)</h4>'.PHP_EOL;
echo '<textarea id="book_isbn_box" onchange="set_book_isbn();" style="width: 100%;height: 2em;" >'.$bfs['book_isbn'].'</textarea>';

echo '<h4>Milyen nyelven íródott?</h4>'.PHP_EOL;
echo '<textarea id="book_language_box" onchange="set_book_language();" style="width: 100%;height: 2em;" >'.$bfs['book_language'].'</textarea>';

echo '<h4>A könyved állapota</h4>'.PHP_EOL;
echo '<textarea id="book_condition_box" onchange="set_book_condition();" style="width: 100%;height: 2em;" >'.$bfs['book_condition'].'</textarea>';

echo '<h4>Kiadója</h4>'.PHP_EOL;
echo '<textarea id="book_publisher_box" onchange="set_book_publisher();" style="width: 100%;height: 2em;" >'.$bfs['book_publisher'].'</textarea>';
